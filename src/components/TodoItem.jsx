...
import { Check, Trash2, Calendar, PencilLine } from "lucide-react";
...
const TodoItem = ({ todo }) => {
  ...
  return (
    <>
      ...
      <EditTodoDetails isOpen={isOpen} onClose={() => setIsOpen(false)} todoId= {todo?._id} orgTitle={todo?.title} orgDescription={todo?.description} orgPriority={todo?.priority} />
    </>
  )
}
